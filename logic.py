...
class DatabaseManager:
    ...
    def get_users(self):
        ...
        with conn:
            cur = conn.cursor()
            cur.execute("SELECT user_id FROM users")  # Добавил SQL-запрос
    ...
    def get_prize_img(self, prize_id):
        ...
        with conn:
            ...
            return cur.fetchone()[0]  # Используем fetchone(), так как ожидаем один результат
    ...
    def get_random_prize(self):
        ...
        with conn:
            ...
            return cur.fetchone()  # Аналогично fetchone(), чтобы избежать IndexError
    ...
    def get_rating(self):
        ...
        with conn:
            cur = conn.cursor()
            cur.execute('''
                        SELECT user.user_name, COUNT(winners.prize_id) as count_prize FROM winners
